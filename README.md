...
```
The previous example will load the latest bundled code from the umd branch. Alternatively, you may load a specific version by loading the file from one of the [tagged bundles](https://github.com/stdlib-js/array-dtypes/tags). For example,

```javascript
dtypes = require( 'https://cdn.jsdelivr.net/gh/stdlib-js/array-dtypes@v0.4.1-umd/browser.js' )
```
